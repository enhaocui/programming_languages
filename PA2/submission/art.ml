...
let rec build (rand,depth) = 
  let x = rand(0,8) in 
    ...
    | 0 -> buildSine(build(rand, depth - 2))
    | 3 -> buildCosine(build(rand, depth - 1))
    | 4 -> buildTimes(build(rand, depth - 2),build(rand, depth - 1))
    | 1 -> buildAverage(build(rand, depth - 1),build(rand, depth - 2))
    | 5 -> buildTimes(build(rand, depth - 1),build(rand, depth - 2))
    | 6 -> buildThresh(build(rand, depth - 1),build(rand, depth - 1),build(rand, depth - 2),build(rand, depth - 1))
    | _ -> buildY();;
...
let rec build2 (rand,depth) = 
  let x = rand(0,10) in
    ...
    | 0 -> buildSine(build2(rand, depth - 2))
    | 3 -> buildCosine(build2(rand, depth - 1))
    | 4 -> buildTimes(build2(rand, depth - 2),build2(rand, depth - 1))
    | 1 -> buildAverage(build2(rand, depth - 1),build2(rand, depth - 2))
    | 5 -> buildTimes(build2(rand, depth - 1),build2(rand, depth - 2))
    | 6 -> buildThresh(build2(rand, depth - 1),build2(rand, depth - 1),build2(rand, depth - 2),build2(rand, depth - 1))
    | 7 -> buildAbsin(build2(rand, depth - 1))
    | 8 -> buildMax(build2(rand, depth - 1), build2(rand, depth - 1), build2(rand, depth - 1))
    | _ -> buildY();;
